...
class HomesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create home" do
    assert_difference('Home.count') do
      post homes_url, params: { home: { email: @home.email, name: @home.name, password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update home" do
    patch home_url(@home), params: { home: { email: @home.email, name: @home.name, password: 'secret', password_confirmation: 'secret' } }
